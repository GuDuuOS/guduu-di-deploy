  ...
  $driver.setSteps([
    {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            Create and manage <b>Question-SQL pairs</b> to refine Guduu DI’s SQL
            ...
            save, the smarter Guduu DI becomes!
          </>,
        ),
        onPopoverRender: (popoverDom: DriverPopoverDOM) => {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            ...
            guide Guduu DI in applying consistent filters, constraints, and best
