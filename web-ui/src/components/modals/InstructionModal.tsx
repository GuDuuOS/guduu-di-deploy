    ...
    >
      <Form form={form} preserve={false} layout="vertical">
        ...
        >
          <Input.TextArea
            autoFocus
            placeholder="Enter a rule that Guduu DI should follow when generating SQL queries."
            maxLength={1000}
            rows={3}
            showCount
          />
        ...
        {!isDefault && (
          <Form.Item
            ...
            required
            extra="Guduu DI will match user queries based on similarity and apply this instruction when relevant."
          >
